...
{
    public class DealershipDiscountConfiguration : IEntityTypeConfiguration<DealershipDiscount>
    {
        public void Configure(EntityTypeBuilder<DealershipDiscount> builder)
        {
